...
// or intended. Every imported round lands in the given tenant. Returns the
// number of rounds imported.
async function importRounds(tenant, rounds) {
  for (const round of rounds) data.rounds.push({ ...structuredClone(round), tenantId: tenant });
  saveData();
